...
(function() {
  ...
  const API_FUNCTIONS = {
    ...
    // تسجيل
    recordViolation:       (studentsData, violationType, notes, recorder, severity, signature, fingerprint, category, score, subject, actionType, actionTaken, subType, visibleToParentOverride)
                                                     => callAPI('recordViolation', { studentsData, violationType, notes, recorder, severity, signature, fingerprint, category, score, subject, actionType, actionTaken, subType, visibleToParentOverride }),
    recordPositiveBehavior:(studentsData, behaviorType, notes, recorder, score, subType, sendMessage)
                                                     => callAPI('recordPositiveBehavior', { studentsData, behaviorType, notes, recorder, score, subType, sendMessage }),
